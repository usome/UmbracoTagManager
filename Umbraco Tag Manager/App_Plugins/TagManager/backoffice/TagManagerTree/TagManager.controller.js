...
angular.module("umbraco").controller("TagManager.TagManagerDeleteController",
    function ($scope, $routeParams, $location, TagManagerResource, notificationsService, navigationService, $route, treeService, appState, dialogService) {
